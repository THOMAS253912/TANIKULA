    ...
    <section class="item-details mt-md-4 section bg-white overflow-hidden">
        <div class="container">
            <div class="bg-white">
                ...
                <form action="#" method="POST" id="create_orders" accept-charset="utf-8" enctype="multipart/form-data">
                    @csrf
                    ...
                    <div class="row">
                        <div class="col-12 col-xl-8 mb-3 mb-xl-0 mb-5 mb-md-0">
                            ...
                            <div class="mb-12 py-3 mt-3"
                                style="border-top: 1px solid #16A085; border-bottom: 1px solid #16A085;" id="product_data">
                                                ...
                                                <div class="row align-items-center">
                                                    ...
                                                    <div class="col-12 mt-2 mt-md-0">
                                                        ...
                                                        <p>
                                                            ...
                                                            [TaniKula Note: {{ $item->complete_address }}
    ...
    <script type="text/javascript">
        ...
        $(document).ready(function() {
            ...
            $('#btn-check').click(function(e) {
                ...
                let origin_gapoktan = $('#origin').val();
