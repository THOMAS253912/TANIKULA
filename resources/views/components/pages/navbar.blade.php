                                        ...
                                        <ul class="shopping-list" id="{{ $cartItem->count() > 1 ? 'style-2' : '' }}">
                                            ...
                                            @foreach ($cartItem as $item)
                                                <div class="d-flex navbarCheckProductCart">
                                                    ...
                                                    <input class="form-check-input" type="hidden"
                                                        name="navbar_cart_total" value="{{ $item->product->price }}"
                                            ...
                                            @if ($cartItemOutOfStock->count() > 0)
                                                <div class="mb-2 pb-1 d-flex align-items-center border-bottom fw-bold">
                    ...
                    <nav class="navbar navbar-expand-lg">
                        ...
                        <div class="collapse navbar-collapse sub-menu-bar" id="navbarSupportedContent">
                            <ul id="nav" class="navbar-nav ms-auto">
                                ...
                                <li class="nav-item">
                                    <a href="/company" class="" target="blank"
                                        aria-label="Toggle navigation">Company
                                        profile</a>
                                </li>
